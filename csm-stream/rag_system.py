...
class RAGSystem:
    ...
    def _load_conversations(self):
        ...
        try:
            ...
            for conv_id, user_message, ai_message in conversations:
                ...
                if (
                    user_message is not None and ai_message is not None
    ...
    def _process_conversation(
        self, conv_id: int, user_message: str, ai_message: str, conn: sqlite3.Connection
    ):
    ...
    def get_context(
        self, query_text: str, top_k: int = 3, threshold: float = 0.6
    ) -> str:
        """
